...
#define kFlatDatePickerIconValid @"icon-right.png"
...
-(id)initWithParentView:(UIView*)parentView {
    ...
    if ([self initWithFrame:CGRectMake(0, screenHeight - UpHeight - kFlatDatePickerHeight, _parentView.frame.size.width, kFlatDatePickerHeight)]) {
        _datePickerMode = FlatDatePickerModeDate;
...
//    self.backgroundColor = [UIColor redColor];
    ...
    if (self.datePickerMode == FlatDatePickerModeDate) {
        ...
        [self buildSelectorYearsOffsetX:0.0
                               andWidth:kFlatDatePickerScrollViewDaysWidth];
        [self buildSelectorMonthsOffsetX:(_scollViewYears.frame.size.width + kFlatDatePickerScrollViewLeftMargin) andWidth:kFlatDatePickerScrollViewMonthWidth];
        [self buildSelectorDaysOffsetX:(_scollViewMonths.frame.origin.x + _scollViewMonths.frame.size.width + kFlatDatePickerScrollViewLeftMargin)
                              andWidth:(self.frame.size.width - (_scollViewMonths.frame.origin.x + _scollViewMonths.frame.size.width + kFlatDatePickerScrollViewLeftMargin))];
        
//        [self buildSelectorYearsOffsetX:0.0
//                               andWidth:kFlatDatePickerScrollViewDaysWidth];
//        [self buildSelectorMonthsOffsetX:(_scollViewYears.frame.size.width + kFlatDatePickerScrollViewLeftMargin)
//                                andWidth:kFlatDatePickerScrollViewMonthWidth];
//        [self buildSelectorDaysOffsetX:(_scollViewMonths.frame.origin.x + _scollViewMonths.frame.size.width + kFlatDatePickerScrollViewLeftMargin)
//                              andWidth:(self.frame.size.width - (_scollViewMonths.frame.origin.x + _scollViewMonths.frame.size.width + kFlatDatePickerScrollViewLeftMargin))];
    }
